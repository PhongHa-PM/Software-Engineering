namespace QL_Bida
{
    partial class fSuaThucDon
    {
        ...
        private void InitializeComponent()
        {
            ...
            cboNhomThucDon.Items.AddRange(new object[] { "Bia", "Thuốc Lá", "Rượu", "Sinh Tố", "Trà", "Cà Phê", "Bánh", "Mì", "Cơm", "Nước Ngọt" });
            ...
            cboDonViTinh.Items.AddRange(new object[] { "Phần", "Tô", "Ly", "Bao", "Lon", "Chai", "Đĩa", "Hộp", "Gói", "Cốc" });
